...
terraform {
  source = "${get_repo_root()}/modules/cloudflare-dns-zone"
}
...
inputs = {
  ...
  records = {
    ...
    "www_redirect" = {
      ...
      value   = "192.0.2.1"
      proxied = true
      comment = "Managed by github.com/mirceanton/cloud-terraform | www Redirect to Primary Domain"
    }
    "root_redirect" = {
      type    = "A"
      name    = "@"
      value   = "192.0.2.1"
      proxied = true
      comment = "Managed by github.com/mirceanton/cloud-terraform | Root Domain Redirect"
    }
  }
}
